        ...
        if( what_data_to_load === root_this_.possible_datasets__commitments ){
            ...
            jQuery( document ).ready( function(){
                ...
                $.get( root_this_.table_data__commitment_data__url, function(data){
                    ...
                    root_this_.our_table_view_obj__commitents_data_edition.format_loaded_data_according_to_the_relevant_column_order__NEW( root_this_.our_table_view_obj__commitents_data_edition, root_this_.table_data__RAW__commitmentData_edition, true );
