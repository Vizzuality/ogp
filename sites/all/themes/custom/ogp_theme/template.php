 ...
 */
function ogp_theme_file_link($variables) {
 $file = $variables['file'];
...
function ogp_theme_file_entity_download_link($variables) {
  $file = $variables['file'];
  $icon_directory = $variables['icon_directory'];
...
function ogp_theme_preprocess_node(&$vars) {
 ...
 * @ingroup themeable
 */
function ogp_theme_facetapi_link_inactive($variables) {
 ...
 * @ingroup themeable
 */
function ogp_theme_facetapi_link_active($variables) {
