...
<nav class="c-main-menu <?php if (drupal_is_front_page() == false) { echo '-page'; } ?>">
  <ul class="primary-menu">
    ...
    <li class="text -menu"><svg class="icon -medium"><use xlink:href="#icon-search"></use></svg></li>
  </ul>
</nav>
