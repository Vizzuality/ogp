...
hide($content['links']);
hide($content['field_blog_post_header_image']);
hide($content['disqus']);
?>
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  <?php print render($title_prefix); ?>

  <?php if ( !empty($node->field_blog_post_header_image) ): ?>
    <div class="blog-post-title-wrapper">
      <?php print theme('image_style', array('path' => $content['field_blog_post_header_image']['#items'][0]['uri'], 'style_name' => 'blog_post_header_image')); ?>
      <?php if ($variables['created']): ?>
        <div class="blog-post-date">
          <?php print gmdate("j F Y", $variables['created']) ?>
        </div>
      <?php endif; ?>
      <?php if ($title): ?>
      ...
      <?php if ($name): ?>
        <div class="blog-post-author">
          by <?php print render($content['field_blog_authors']) //$name ?>
        </div>
      <?php endif; ?>
    </div>
  <?php else: ?>
  ...
  <div class="blog-post-content-wrapper">
    ...
    <div class="short-user-info <?php print (!empty($user_picture)? 'user-picture': '') ?>">
      <?php print views_embed_view('blog_authors', 'block'); ?>
    </div>
